...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			'top_bar_background_color' => '#02f585',
			'top_bar_text_color' => '#020202',
			'top_bar_link_color' => '#020202',
			'top_bar_link_color_hover' => '#020202',
			'header_background_color' => '#ffec00',
			'header_text_color' => '#020202',
			'header_link_color' => '#020202',
			'header_link_hover_color' => '#020202',
			'site_title_color' => '#5b8bee',
			'site_tagline_color' => '#020202',
			'navigation_background_color' => '#ffec00',
			'navigation_text_color' => '#020202',
			'navigation_background_hover_color' => '',
			'navigation_text_hover_color' => '#020202',
			'navigation_background_current_color' => '',
			'navigation_text_current_color' => '',
			'subnavigation_background_color' => '#ffec00',
			'subnavigation_text_color' => '#ffffff',
			'subnavigation_background_hover_color' => '',
			'subnavigation_text_hover_color' => '#020202',
			'subnavigation_background_current_color' => '',
			'subnavigation_text_current_color' => '',
			'fixed_side_content_background_color' => '#02f585',
			'fixed_side_content_text_color' => '#020202',
			'fixed_side_content_link_color' => '#020202',
			'fixed_side_content_link_hover_color' => '#020202',
			'content_background_color' => '',
			'content_text_color' => '',
			'content_link_color' => '',
			'content_link_hover_color' => '',
			'content_title_color' => '',
			'blog_header_bg_color' => '#020202',
			'blog_header_bg_s_color' => 'rgba(255,255,255,0)',
			'blog_header_title_color' => '#ffec00',
			'blog_header_text_color' => '#ffffff',
			'blog_header_button' => '#020202',
			'blog_header_button_bg' => '#ff8bb8',
			'blog_header_button_hover' => '#020202',
			'blog_header_button_hover_bg' => '#02f585',
			...
			'h5_color' => '',
			'h6_color' => '',
			'sidebar_widget_background_color' => '#ff8bb8',
			'sidebar_widget_text_color' => '#020202',
			'sidebar_widget_link_color' => '#ffec00',
			'sidebar_widget_link_hover_color' => '#020202',
			'sidebar_widget_title_color' => '#020202',
			'footer_widget_background_color' => '#ff8bb8',
			'footer_widget_text_color' => '#020202',
			'footer_widget_link_color' => '#ffec00',
			'footer_widget_link_hover_color' => '#020202',
			'footer_widget_title_color' => '#020202',
			'footer_background_color' => '#02f585',
			'footer_text_color' => '#020202',
			'footer_link_color' => '#020202',
			'footer_link_hover_color' => '#020202',
			'form_background_color' => '#020202',
			'form_text_color' => '#ffffff',
			'form_background_color_focus' => '#ffeb02',
			'form_text_color_focus' => '#020202',
			'form_border_color' => '#020202',
			'form_border_color_focus' => '#020202',
			'form_button_background_color' => '#ff8bb8',
			'form_button_background_color_hover' => '#02f585',
			'form_button_text_color' => '#020202',
			'form_button_text_color_hover' => '#020202',
			'back_to_top_background_color' => '#ff8bb8',
			'back_to_top_background_color_hover' => '#02f585',
			'back_to_top_text_color' => '#020202',
			'back_to_top_text_color_hover' => '#020202',
		);
...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			...
			'top_bar_font_transform' => 'uppercase',
			'top_bar_font_size' => '25',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Roboto:100,300,regular,500,700,900|Rubik:300,regular,500,700,900' );
