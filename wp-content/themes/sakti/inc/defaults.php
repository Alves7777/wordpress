...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			...
			'blog_header_title_color' => '#f9cb40',
			'blog_header_text_color' => '#ffffff',
			'blog_header_button' => '#eeeeee',
			'blog_header_button_bg' => '#222222',
			'blog_header_button_hover' => '#eeeeee',
			'blog_header_button_hover_bg' => '#fc440f',
			...
			'h5_color' => '',
			'h6_color' => '',
			'sidebar_widget_background_color' => '#fc440f',
			'sidebar_widget_text_color' => '#222222',
			'sidebar_widget_link_color' => '#eeeeee',
			'sidebar_widget_link_hover_color' => '#222222',
			'sidebar_widget_title_color' => '#f9cb40',
			'footer_widget_background_color' => '#fc440f',
			'footer_widget_text_color' => '#222222',
			'footer_widget_link_color' => '#eeeeee',
			'footer_widget_link_hover_color' => '#222222',
			'footer_widget_title_color' => '#f9cb40',
			'footer_background_color' => '#222222',
			'footer_text_color' => '#eeeeee',
			'footer_link_color' => '#f9cb40',
			'footer_link_hover_color' => '#eeeeee',
			'form_background_color' => '#222222',
			'form_text_color' => '#eeeeee',
			'form_background_color_focus' => '#fc440f',
			'form_text_color_focus' => '#eeeeee',
			'form_border_color' => '#222222',
			'form_border_color_focus' => '#222222',
			'form_button_background_color' => '#222222',
			'form_button_background_color_hover' => '#fc440f',
			'form_button_text_color' => '#eeeeee',
			'form_button_text_color_hover' => '#eeeeee',
			'back_to_top_background_color' => '#f9cb40',
			'back_to_top_background_color_hover' => '#fc440f',
...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			...
			'font_blog_header_text' => 'Quattrocento',
			'font_blog_header_text_category' => '',
			'font_blog_header_text_variants' => 'regular,700',
			...
			'font_heading_1' => 'Oswald',
			'font_heading_1_category' => '',
			'font_heading_1_variants' => '200,300,regular,500,600,700',
			'heading_1_weight' => '600',
			'heading_1_transform' => 'none',
			'heading_1_font_size' => '60',
			'heading_1_line_height' => '1.2', // em
			'mobile_heading_1_font_size' => '30',
			'font_heading_2' => 'Oswald',
			'font_heading_2_category' => '',
			'font_heading_2_variants' => '200,300,regular,500,600,700',
			'heading_2_weight' => '600',
			'heading_2_transform' => 'none',
			'heading_2_font_size' => '32',
			'heading_2_line_height' => '1.2', // em
			'mobile_heading_2_font_size' => '25',
			'font_heading_3' => 'Oswald',
			'font_heading_3_category' => '',
			'font_heading_3_variants' => '200,300,regular,500,600,700',
			'heading_3_weight' => '600',
			'heading_3_transform' => 'none',
			'heading_3_font_size' => '25',
			'heading_3_line_height' => '1.2', // em
			'font_heading_4' => 'Oswald',
			'font_heading_4_category' => '',
			'font_heading_4_variants' => '200,300,regular,500,600,700',
			'heading_4_weight' => 'normal',
			'heading_4_transform' => 'none',
			'heading_4_font_size' => '',
			'heading_4_line_height' => '', // em
			'font_heading_5' => 'Oswald',
			'font_heading_5_category' => '',
			'font_heading_5_variants' => '200,300,regular,500,600,700',
			'heading_5_weight' => 'normal',
			'heading_5_transform' => 'none',
			'heading_5_font_size' => '',
			'heading_5_line_height' => '', // em
			'font_heading_6' => 'Oswald',
			'font_heading_6_category' => '',
			'font_heading_6_variants' => '200,300,regular,500,600,700',
			'heading_6_weight' => 'normal',
			'heading_6_transform' => 'none',
			'heading_6_font_size' => '',
			'heading_6_line_height' => '', // em
			'font_footer' => 'Quattrocento',
			'font_footer_category' => '',
			'font_footer_variants' => 'regular,700',
			'footer_weight' => '700',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Quattrocento:regular,700|Oswald:200,300,regular,500,600,700' );
