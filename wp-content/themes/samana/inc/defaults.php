...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			...
			'form_button_background_color' => '#db242b',
			'form_button_background_color_hover' => '#222222',
			'form_button_text_color' => '#b2ceff',
			'form_button_text_color_hover' => '#b2ceff',
			'back_to_top_background_color' => '#b2ceff',
			'back_to_top_background_color_hover' => '#222222',
			'back_to_top_text_color' => '#222222',
			'back_to_top_text_color_hover' => '#b2ceff',
		);
...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			...
			'footer_font_size' => '18',
			'font_fixed_side' => 'Montserrat',
			'font_fixed_side_category' => '',
			'font_fixed_side_variants' => '100,100italic,200,200italic,300,300italic,regular,italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic',
